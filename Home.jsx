    ...
    >
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-red-900 to-red-600 bg-clip-text text-transparent leading-right">
            Hello, I'm Jaic Andrades
          </h1>
          <h2 className="tex-gray-400 text-2xl mb-8 max-w-lg mx-auto">
            Beginner full-stack web developer
          </h2>
          <p className="tex-gray-400 text-base mb-8 max-w-lg mx-auto">
            Dedicated to improvment, innovation, and creative thinking.
          </p>
          <div className="flex justify-center space-x-4">
            <a
              href="#projects"
              className="bg-red-800 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)]"
            >
              View Projects
            </a>
